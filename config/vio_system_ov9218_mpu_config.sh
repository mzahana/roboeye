...
# rovio
#
export VIO_CONFIG_FILE='/home/vio/config/rovio_config_ov9218_mpu/rovio_rpi.info'
export VIO_CAM0_CONFIG_FILE='/home/vio/config/rovio_config_ov9218_mpu/ov9218.yaml'
